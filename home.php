...
<div class="panel panel-warning">
  <div class="panel-heading">
    <span class="glyphicon glyphicon-copy" aria-hidden="true"></span> Add Income / Expense  </div>
  <div class="panel-body">
...
<div class="panel panel-warning">
  <div class="panel-heading">
    <span class="glyphicon glyphicon-search" aria-hidden="true"></span> Track Expense Record
  </div>
  <div class="panel-body">
  <div class="col-lg-8">
  ...
  <form action="home.php" class="form-horizontal"  name="showexp" method="post">
              <div class="form-group">
                <div class="input-group form_datetime" >      
                    <input class="form-control" size="60" type="text" value="" name="expdetail" placeholder="Describe expense to find" >
                </div>
              </div>
...
if ($result->num_rows > 0) 
    ...
    while($row = $result->fetch_assoc()) 
    {
      ...
      $exdate = date('d M Y', $exdate);
        ...
        echo "<tr><td> </td> <td class='alert alert-danger' role='alert'> No Expenses in specified dates</td><td> </td></tr>";
}
